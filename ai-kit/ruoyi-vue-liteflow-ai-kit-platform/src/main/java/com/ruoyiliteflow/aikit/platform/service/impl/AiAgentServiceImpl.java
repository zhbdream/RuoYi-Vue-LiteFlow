...
public class AiAgentServiceImpl implements IAiAgentService
{
    ...
    @Override
    public AgentRunResult stream(String agentCode, AgentRunRequest request,
            com.ruoyiliteflow.aicore.spi.AgentStreamListener listener)
    {
        return agentRuntime.stream(agentCode, request, listener);
    }
