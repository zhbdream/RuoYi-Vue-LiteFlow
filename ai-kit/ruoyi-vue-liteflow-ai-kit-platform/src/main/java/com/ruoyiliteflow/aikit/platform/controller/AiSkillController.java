...
public class AiSkillController extends BaseController
{
    ...
    public AjaxResult run(@PathVariable String skillCode, @RequestBody(required = false) AgentRunRequest request)
    {
        if (request == null)
        {
        ...
        return success(aiSkillService.tryRun(skillCode, request));
    }
