...
import com.ruoyiliteflow.common.filter.RefererFilter;
import com.ruoyiliteflow.common.filter.RepeatableFilter;
import com.ruoyiliteflow.common.filter.XssFilter;
...
public class FilterConfig
{
    ...
    @Value("${referer.allowed-domains:localhost,127.0.0.1}")
