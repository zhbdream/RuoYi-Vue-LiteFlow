package com.ruoyiliteflow.agentrag.config;
...
@Configuration
public class AgentRagSecurityConfig
{
    @Bean
    public SecurityFilterChain agentRagSecurityFilterChain(HttpSecurity http) throws Exception
    {
    ...
    @Component
    @ConfigurationProperties(prefix = "ruoyi.agent.rag")
    public static class AgentRagProperties
    {
