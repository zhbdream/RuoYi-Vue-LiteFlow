...
public class McpAiCoreController
{
    ...
    {
        ensureAiCore();
        return AjaxResult.success(aiCoreMcpTools.listTools());
    }
    ...
    {
        ensureAiCore();
        return AjaxResult.success(aiCoreMcpTools.call(toolName, body));
    }
    ...
    public SseEmitter sse()
    {
        ...
        try
        {
            emitter.send(SseEmitter.event().name("tools").data(aiCoreMcpTools.listTools()));
